...
Durante la realización de este proyecto se ha empleado una herramienta de IA como apoyo al aprendizaje, con el objetivo de **comprender en profundidad el código** y poder defenderlo. En concreto, la IA se ha utilizado para:

- Explicar el funcionamiento de conceptos clave del proyecto: el mecanismo de argumentos variádicos (`va_list`, `va_arg`), la recursión aplicada a la impresión de números en distintas bases y las promociones de tipo en funciones variádicas.
- Aclarar dudas sobre casos límite (`INT_MIN`, punteros nulos) y sobre el comportamiento de la función de referencia.
...
La IA no ha sustituido la escritura ni el diseño de la lógica del proyecto, sino que ha servido como recurso de estudio para consolidar la comprensión de cada parte de la implementación.
